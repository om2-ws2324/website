...
## BigQuery for Marketing Analysts Badges
...
:::{.callout-important}
Use an Incognito or private browser window to create a new [Google Cloud account](https://www.cloudskillsboost.google/users/sign_up) (choose the option "create account" at the bottom of the page) with your **HdM-mail**. This prevents any conflicts between your personal account and the student account you need for the labs
:::
...
:::{.callout-caution}
You dont need to complete all of the labs provided in the BigQuery for Marketing Analysts course (only the first 5 labs are relevant)
:::
